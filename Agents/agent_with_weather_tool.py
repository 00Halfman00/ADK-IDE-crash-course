...
# <-----  IV.   DEFINE THE SPECIALIST AGENTS  ------>

from agents import create_weather_planner_agent
weather_agent = create_weather_planner_agent(get_live_weather_forecast)
...
#  <-----     V.    FUNCTION TO TEST THE WEATHER PLANNER AGENT    ----->

async def run_weather_planner_agent() -> None:
...
if __name__ == "__main__":
    asyncio.run(run_weather_planner_agent())
